...
modbus_tcp_binary_ns = cg.esphome_ns.namespace("modbus_tcp_binary")
ModbusTCPbinary = modbus_tcp_binary_ns.class_("ModbusTCPbinary", binary_sensor.BinarySensor, cg.PollingComponent)


CONFIG_SCHEMA = cv.Schema(
    binary_sensor.binary_sensor_schema(ModbusTCPbinary)
    .extend(
        {
        cv.GenerateID(): cv.declare_id(ModbusTCPbinary),
